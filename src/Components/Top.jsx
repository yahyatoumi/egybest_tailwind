...
const Top = () => {
    return (
        <div className='h-screen ml-0 sm:ml-16 sm:w-vw-16 sm:h-[60vh] min-h-[400px]'>
      ...
      <div
        className="bg-cover bg-center bg-no-repeat h-2/5 sm:h-[60vh] min-h-[400px]"
        style={{
          backgroundImage: "url('https://hervehubert.tv/wp-content/uploads/2019/10/Logo-full-hd-1.jpg')",
        }}
      ></div>
      <div className='bg-black sm:bg-transparent text-white min-h-[400px] h-3/5 p-5 pb-10 flex flex-col gap-5 sm:absolute sm:top-0 sm:bg-gradient-to-br sm:from-black sm:to-transparent  sm:w-vw-16 sm:h-[60vh]'>
